...
In the last few months I just started learn how to code, I already know how to partly work with JavaScript and start to learn TypeScript. When I was create TypeScript types I found a lot of tutorials and documentation that help me create Types and how to implement them in my code. For example: **Discriminated Union.**
...
## So how do we create Types based GraphQL schema?
